...
{
  public:
    [[nodiscard]] Architecture architecture() const override
    {
        return architecture_;
    }
    [[nodiscard]] usize hardware_thread_count() const override
    {
        return 1;
    }
  ...
  protected:
    ...
    static void compiler_fence() noexcept
    {
...
template <Architecture A> class ProfiledArchOperationsBase : public ArchOperationsBase
{
  public:
    ...
    {
        return ArchTraits<A>::name;
    }
    [[nodiscard]] usize page_size() const override
    {
        return ArchTraits<A>::page_size;
    }
    [[nodiscard]] usize register_count() const override
    {
        return ArchTraits<A>::register_count;
    }
    [[nodiscard]] Endianness endianness() const override
    {
        return ArchTraits<A>::endianness;
    }
    [[nodiscard]] usize hardware_thread_count() const override
    {
        return ArchTraits<A>::hardware_threads;
    }
    [[nodiscard]] bool supports_user_mode() const override
    {
        return ArchTraits<A>::has_user_mode;
    }
};
