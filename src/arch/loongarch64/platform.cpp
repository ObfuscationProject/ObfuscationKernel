...
#include "ok/driver/qemu_virt/virtio_pci_input.hpp"

namespace
{

constexpr ok::uptr uart_base = 0x1fe001e0;
constexpr ok::uptr fw_cfg_base = 0x1e020000;
constexpr ok::uptr pcie_ecam_base = 0x20000000;
constexpr ok::uptr pcie_mmio_base = 0x40000000;
...
using VirtioPciInput = ok::driver::qemu_virt::VirtioPciInputDevice<pcie_ecam_base, pcie_mmio_base>;

VirtioPciInput virtio_keyboard;
...
{
    virtio_mouse.initialize(ok::driver::qemu_virt::VirtioInputKind::mouse);
...
int poll_virtio_keyboard()
{
    ...
    virtio_keyboard.initialize(ok::driver::qemu_virt::VirtioInputKind::keyboard);
    ok::driver::qemu_virt::VirtioInputEvent event{};
