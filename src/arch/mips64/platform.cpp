...
constexpr ok::uptr uart_primary_base = 0xffffffffb80003f8ull;   // Malta ISA COM1 through PCI I/O KSEG1 window.
constexpr ok::uptr uart_secondary_base = 0xffffffffb80002f8ull; // Malta ISA COM2 through PCI I/O KSEG1 window.
